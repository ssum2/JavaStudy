...
import my.day5.SwitchCaseTest1;
...
public class CalendarTest {
	...
	public static void main(String[] args) {
		...
		String strMonth2 = month2<10?"0"+month2:String.valueOf(month2); 
											// String.valueOf(int) -> int값을 String타입으로 변환
		...
		*/
        ...
        System.out.println("이 해의 몇 일: " + currentdate.get(Calendar.DAY_OF_YEAR)); // 지정년도의 몇번째 일인가
     ...
     // 요일 출력하기; 내가 그냥 배열로 해본 것
        ...
        System.out.println("현재는 "+ MyUtil.currentTime3() +" 입니다.");
        
        // 2018-08-20 10:12:07 월요일
